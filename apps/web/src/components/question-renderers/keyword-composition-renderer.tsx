...
import { KeywordChecklist } from '@/components/hsk/KeywordChecklist';
import { CharacterCounter } from '@/components/hsk/CharacterCounter';

interface KeywordCompositionMeta {
  type: string;
  keywords: string[];
...
export function KeywordCompositionRenderer({
  group,
  questions,
  answers,
  onAnswer,
  ...
  return (
    <div>
      ...
      {questions.map((question, idx) => {
        const meta = (question.metadata || {}) as unknown as KeywordCompositionMeta;
        ...
        return (
          <div key={question.id}>
            ...
            {/* Keywords display */}
            <div className="mb-3">
              <KeywordChecklist keywords={keywords} text={answer} />
            </div>
